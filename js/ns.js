...
PODEZD.CONFIG = {
  ...
  ITEM_UPGRADE_BASE: 10,    // цена прокачки: floor(base * 1.4^L) + 10% от score
  ITEM_UPGRADE_GROW: 1.4,
  TRAIN_COST_BASE: 15,      // «Самоделки»: floor(base * 1.35^L) за уровень (калибровка симулятора; в плане было 25)
